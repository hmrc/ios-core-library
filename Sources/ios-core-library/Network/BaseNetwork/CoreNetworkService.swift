...
extension MobileCore.Network {
    ...
    open class Service: BaseNetworkSpinnerConsumer, CoreNetworkService {
        ...
        open func data(
            ...
            sessionType: MobileCore.Network.SessionType,
            attempt: Int, _ handler: @escaping NetworkHandler
        ) {
